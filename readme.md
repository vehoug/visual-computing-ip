...
1. Assignment 1: Friday October 17th, 23:59 PM
2. Assignment 2 Friday October 31st ,23:59 PM
3. Assignment 3: Friday November 14th, 23:59 PM

The starting source code for each assignment will be published during the semester.


### Assignment 0
Optional introduction for calculus, multivariate calculus, linear algebra, statistics, and practical skills in matrix manipulation with NumPy.
...
```bash
git clone https://github.com/TDT4195-tutorial/TDT4195-StarterCode-2025.git
```
